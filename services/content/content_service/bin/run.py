...
def run_seed() -> None:
    ...
    from content_service.bin.seed import seed
...
def run_api() -> None:
    ...
    container), 8001 to sit alongside game-service's 8000 in local compose.
    """
    uvicorn.run(
        "content_service.api.app:app",
        host="0.0.0.0",
        port=8001,
